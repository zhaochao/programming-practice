...
to parse. It then parses the log file and generate a report which
associate remote hosts with number of bytes transferred to them.
"""
...
def generate_log_report(logfile):
    ...
    This function takes a file object, iterate through all the lines in the file,
    and generate a report of the number of bytes transferred to each remote host
    for eash hit on the webserver.
    '''
