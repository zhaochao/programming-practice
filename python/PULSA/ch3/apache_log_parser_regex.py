...
associates remote hosts with number of bytes trafferred to them.
"""
...
def dictify_logline(line):
    ...
    Currently, the only fields we are interested in the remote host and bytes sent,
    but we are putting status there just for good measure.
    '''
...
def generate_log_report(logfile):
    ...
    for line in logfile:
        ...
        try:
            ...
            ##totally disgard anything we don't understand
            continue
